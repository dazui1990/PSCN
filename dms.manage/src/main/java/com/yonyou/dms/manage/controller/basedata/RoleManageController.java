...
public class RoleManageController {
	 ...
	 * @return
	 */
	@RequestMapping( value = "/roletype/{roletype}",method = RequestMethod.GET)
	@ResponseBody
	public PageInfoDto queryOperateLogByRoleType(@RequestParam Map<String, String> queryParam,@PathVariable(value = "roletype") Integer roletype) {
		PageInfoDto pageInfoDto = roleService.queryRoleForRoleType(queryParam,roletype);
		return pageInfoDto;
	}
...
//		}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/roleData/{id}/{roletype}", method = RequestMethod.GET)
	@ResponseBody
	public Map<String,Object>  roleData(@PathVariable(value = "id")String  id,@PathVariable(value = "roletype")String  roletype){
		//查询角色的菜单控制
		Map<String, String> checkbox=roleCtrlService.queryMenuCtrl(id);

		List<Map> list = roleService.queryMenu(roletype);
	...
	@ResponseBody
	public Map<String,Object>  roleDataModify(@PathVariable(value = "id")String  id){
		//查询角色的菜单控制
		Map<String, String> checkbox=roleCtrlService.queryMenuCtrl(id);

		List<Map> list = roleService.queryMenuForRoleId(id);
		List<CommonTreeDto> orgList = new ArrayList<>(); 
